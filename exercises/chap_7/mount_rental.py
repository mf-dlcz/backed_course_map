...
Players can rent other players' flying mounts from the "Uper" ride sharing guild, but they must return 
the mount before they have used up all their time, or they will be charged a fee.
...
If time_used meets or exceeds time_purchased, then the rental is expired and greedy Uper will 

charge a fee, so the function should return the string "overtime charged"
